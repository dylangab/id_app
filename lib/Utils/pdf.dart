...
class PdfApi {
  ...
  Future<File> generateSingleId(Member member) async {
    ...
    return savefile(name: "demo5", pdf: pdf);
  }
  ...
  Future<File> generateMultiId(List<Member> studentList) async {
    ...
    return savefile(name: "multi1", pdf: pdf);
  }
  ...
  Future<File> generateMultiPage(List<Member> member) async {
    ...
    return savefile(name: "id1", pdf: pdf);
  }
...
*/
  Widget IdFrontOage(Member member, ImageProvider img, Uint8List logo) {
    return Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
      ...
      SizedBox(height: 5),
      Container(height: 256, width: 86, child: Image(img)),
      SizedBox(height: 10),
      Container(
          child:
              Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
    ...
    Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          Padding(
              padding: const EdgeInsets.only(left: 5),
              child: Row(children: [
                //    Image(height: 99, width: 32, MemoryImage()),
                Container(
                    child: Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.start,
